...
export default function DateRangeDialog({ value, onChange, trigger, className }: DateRangeDialogProps) {
  ...
  const defaultTrigger = (
    <Button
      variant="outline"
      className={`justify-start text-left font-normal min-w-64 h-10 bg-input-background border-border hover:bg-accent/50 ${className}`}
    >
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-4xl p-0 overflow-hidden border shadow-lg">
        <div className="p-6">
          <DialogHeader>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-input-background border-border focus:ring-2 focus:ring-primary/20 h-10"
                    data-slot="input"
                  />
                </div>
                ...
                <div className="space-y-1">
                  {presets.map((preset) => (
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      className="w-full justify-start text-sm h-auto py-3 px-3 hover:bg-accent/80 transition-colors rounded-lg border border-transparent hover:border-border/50"
