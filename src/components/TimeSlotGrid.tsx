  ...
  if (error) {
    return (
      <div className={cn("p-4 text-center text-red-600 bg-red-50 rounded-md", className)}>
        ...
        <p className="text-xs mt-1">Please try again or call us at (555) 123-DENTAL</p>
      </div>
    );
  }
  ...
  if (!slots || slots.length === 0) {
    return (
      <div className={cn("p-4 text-center text-orange-600 bg-orange-50 rounded-md", className)}>
        ...
        <p className="text-xs mt-1">Please try another date or call us directly at <strong>(555) 123-DENTAL</strong></p>
      </div>
    );
  }
