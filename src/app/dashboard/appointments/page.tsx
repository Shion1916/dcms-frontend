    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-start mb-8">
        ...
        <div className="flex gap-2">
          ...
          {canBookForPatients && (
            <BookingForm onSuccess={handleRefresh} asDialog={true} />
          )}
        </div>
      </div>
        ...
        <Card>
          <CardContent className="flex items-center p-6">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold">{getStatusCount('booked')}</p>
            </div>
            {isValidating && (
              <div className="ml-auto">
                <div className="h-2 w-2 bg-blue-500 rounded-full animate-pulse"></div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="booked">
            Booked <Badge variant="secondary" className="ml-1">{getStatusCount('booked')}</Badge>
          </TabsTrigger>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        {canManageAppointments && <TableHead>Actions</TableHead>}
                      </TableRow>
                    </TableHeader>
                    <TableBody>
