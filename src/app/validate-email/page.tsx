...
function ValidateEmailPageContent() {
  ...
  useEffect(() => {
    const validateEmail = async () => {
      ...
      if (!token && emailParam) {
        // User came from signup form, show waiting for email page
        setEmail(emailParam);
        setStatus('waiting');
        return;
      ...
      try {
        const response = await fetch(`/api/auth/validate-email?token=${encodeURIComponent(token)}&email=${encodeURIComponent(emailParam)}`);
      ...
      case 'validating':
        return (
          <div className="text-center space-y-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Validating your email...</h3>
              <p className="text-sm text-gray-600 mt-2">
      ...
      case 'success':
        return (
          <div className="text-center space-y-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Email validated successfully!</h3>
              <p className="text-sm text-gray-600 mt-2">
      ...
      case 'expired':
        return (
          <div className="text-center space-y-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Validation link expired</h3>
              <p className="text-sm text-gray-600 mt-2">
